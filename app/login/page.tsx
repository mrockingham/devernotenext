...
const login = () => {
  return (
    <section className="container h-full mx-auto mt-24  flex flex-wrap items-center justify-center">
      ...
      <div className="order-1 flex w-full items-center justify-center  rounded-lg border border-white border-opacity-25 bg-gray-800 bg-opacity-10 bg-clip-padding p-4 md:order-2 md:w-1/2">
        <div className="h-full w-3/6 text-center md:pb-10 md:pt-10 md:text-left   ">
          <h1 className="mb-10 text-4xl font-bold text-primary md:text-5xl ">
            Log In
          </h1>
          <Login />
        </div>
